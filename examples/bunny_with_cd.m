...
do_cd = true;
ym = 80 ; % youngs modulus stiffness
max_steps = 100; 

save_video = true;

%% Load Rig stuff
[V0, F, W, P0] = read_rig_from_json("./data/jellyfish/rig.json", d=2);
F = F(:, [1 3 2]);
P = read_anim_from_json("./data/jellyfish/anim.json", d=2)
...
if(save_video)
    v = VideoWriter('./jellyfish_cd.mp4','MPEG-4');
    v.Quality = 100;
    v.FrameRate = 24;
    open(v)
end;
...
writeOBJSequence("./siqi_jellyfish_recording/", Vs', F, d=2)
